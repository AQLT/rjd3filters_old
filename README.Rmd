...
```{r plot-q0, eval = TRUE}
trend_henderson<- jfilter(y, musgrave[,"q=6"], lags = 6)
trend_musgrave_q0 <- jfilter(y, musgrave[,"q=0"], lags = 6)
trend_fst_q0 <- jfilter(y, fst_notimeliness[[1]], lags = 6)
trend_rkhs_q0 <- jfilter(y, rkhs_timeliness[,"q=0"], lags = 6)
