...
You can also create and manipulate moving average with the class `moving_average`.
In the next example we show how to create the M2X12 moving average, the first moving average used to extract the trend-cycle in X-11, and the M3X3 moving average, applied on each months to extract seasonal component
